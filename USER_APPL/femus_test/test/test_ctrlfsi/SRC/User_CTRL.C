...
//   else if (bc_gam>900)   {bc_Neum[0]=fix_disp0_fix;}
  ...
  // channel_fsi1t.med ===============================================
    bc_Neum[0]= free_disp_ctrl;bc_flag[0]=0;
    bc_Neum[0] = _CTRL_parameter._map_CTRLgroup[bc_gam];
...
//  if (xp[1]>0.2499) {bc_Neum[0]=fix_disp0_ctrl;} 
//  if (xp[1]<-0.2499) {bc_Neum[0]=fix_disp0_ctrl;} 
...
// //   bc_Neum[0]= fix_disp0_fix;bc_flag[0]=0;
//   if (bc_gam< 20){bc_Neum[0]= fix_disp0_fix; }
//   else if (bc_gam<30) {bc_Neum[0]= free_disp;}
//   else if (bc_gam>900)   {bc_Neum[0]=fix_disp0_fix;}
