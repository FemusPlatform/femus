...
//     }
  ...
  MGSolCTRL* mgsctrlx=new MGSolCTRL(*this,nvars_in,"CTRLX","cx"); 
  set_eqs(mgsctrlx);  set_num_eqs(mgsctrlx->_eqname,CTRLX_F);
  #if CTRL_EQUATIONS!=1 

  MGSolCTRL* mgsctrly=new MGSolCTRL(*this,nvars_in,"CTRLY","cy");  
  set_eqs(mgsctrly);  set_num_eqs(mgsctrly->_eqname,CTRLY_F);

#if (DIMENSION==3)
  MGSolCTRL* mgsctrlz=new MGSolCTRL(*this,nvars_in,"CTRLZ","cz"); 
  set_eqs(mgsctrlz);  set_num_eqs(mgsctrlz->_eqname,CTRLZ_F);
#endif
  #endif
