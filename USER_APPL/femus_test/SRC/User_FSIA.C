...
// ===================================
  double ILref = 1./_lref;
   bc_Neum[0] =wall_fsia; bc_flag[0]=0;
   bc_Neum[0] = _FSIA_parameter._map_FSIAgroup[bc_gam];
   
   // channel_fsi1t.med ===============================================
  
//  if (bc_gam == 11) {bc_Neum[0]=outflow_fsia;} //inlet
//  if (bc_gam == 1000 && xp[1] < 0. ) {bc_Neum[0]=wall_fsia;} //inlet
//  if (bc_gam == 21) {bc_Neum[0]=wall_fsia;} //inlet
//  
//  if (bc_gam == 20) {bc_Neum[0]=outflow_fsia;}        //wall
//  if (bc_gam == 15) {bc_Neum[0]=wall_fsia;}        //wall
//  
//  if (bc_gam == 13) {bc_Neum[0]=wall_fsia;}     //outlet
//  if (bc_gam == 1000 && xp[1] > 0. ) {bc_Neum[0]=wall_fsia;} //outlet
//  if (bc_gam == 23) {bc_Neum[0]=wall_fsia;}        //wall
