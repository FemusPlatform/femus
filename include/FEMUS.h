...
class FEMUS {
 ...
 public:
  ...
  inline EquationSystemsExtendedM& get_MGExtSystem() { return *_mg_equations_map; };
  ...
  inline int IsVelFieldActive() {
    int a = 0;
    if (stoi(_mg_utils->_sim_config["MG_NavierStokes"]) != 0 ||
        stoi(_mg_utils->_sim_config["MG_FluidStructure"]) != 0)
      a = 1;
    return a;
  }
  ...
  inline std::string GetMeshDir() { return _mg_utils->_mesh_dir; };
...
//=====================================================================================
  ...
  inline MEDCoupling::MEDCouplingFieldDouble* GetWallDistField(int Level) {
    std::cout << "FEMUS::GetWallDistField NodeWallDist not calculated yet! ";
    abort();
  ...
  void setExtField(const std::string& systemName, MEDCoupling::MEDCouplingFieldDouble* bcField);
  ...
  // ================================================================================================
  //! This function sets the value from first_cmp to end_cmp of the field on the old solution x_old of the
  //! interface id. From Interface to System solution
  ...
  void update_interface(
      ...
      const std::vector<MEDCoupling::MEDCouplingFieldDouble*>&
          srcField  ///< Vector containing displacement MED field */
  );
  ...
  //        MEDCoupling::TypeOfField type, const std::string& fileName, const std::string& meshName, int
  //        meshDimRelToMax, const std::string& fieldName, int iteration, int order
  //                                                   );
