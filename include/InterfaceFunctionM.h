...
class InterfaceFunctionM {
 ...
 public:
  ...
  inline void set_order(const int value) { _order = value; }
  inline int get_order() { return _order; }
  ...
  /// to set in the interface-function. The field in the
  /// interface-function is set by set_mesh_femus_interface
  void update_support(const MEDCoupling::MEDCouplingUMesh* support  ///< med-mesh          (in)
  ) {
    _support_med = support;
  }
  // ============================================================================
