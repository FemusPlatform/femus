...
protected:     
  ...
  const ParaMEDMEM::MEDCouplingUMesh * _support_med_orig; ///< MEDCoupling mesh
...
public:
  ...
  inline void set_support_med(const ParaMEDMEM::MEDCouplingUMesh * support){
    _support_med = support;
  };
  inline void set_NumberOfNodes(const int nodi){
    _n = nodi;
  };
  inline void GetCopyOfInterfaceField(ParaMEDMEM::MEDCouplingFieldDouble *Field){
    Field = _field;
  };
  // set functions ------------------------------------------------------------
// ============================================================================
...
// ============================================================================
  ...
  const ParaMEDMEM::MEDCouplingUMesh * getSupport_orig() {return _support_med_orig;}
