...
class GambitIO : public MeshInput<MeshBase>, public MeshOutput<MeshBase> {
 public:
  /**
  ...
  virtual void write_nodal_data(
      const std::string&, const std::vector<Number>&, const std::vector<std::string>&){} /*= 0*/;
...
inline GambitIO::GambitIO(const MeshBase& mesh) : MeshOutput<MeshBase>(mesh), _binary(false) {}

// =============================================================================
inline GambitIO::GambitIO(MeshBase& mesh)
    : MeshInput<MeshBase>(mesh), MeshOutput<MeshBase>(mesh), _binary(false) {}

// =============================================================================
inline bool& GambitIO::binary() { return _binary; }
