...
class MGGenCase {
 ...
 public:
  ...
  void compute_and_print_MGOps(
      ...
      int* v_inv_el, int** arg9, int* arg10[]);

  /// Compute sparse structures for matrices
  int compute_mat_qq(
      int Level, int Level_row, int Level_clmn, int ndof_ql, int ndof_ql_clmn, int n_nodes, int max_elnd,
      int* off_el, std::vector<std::pair<int, int>> v_el, int** elem_sto, int* v_inv_nd, int** g_indexL,
      int* off_nd, int offM[], int aux[], int mem[], int Mat_q[], int len_q[], int len_qoff[]);
  ...
  int compute_prol_qq(
      int Level1, int Level_row, int Level_clmn, int ndof_row_ql, int n_nodes_c, int* off_el,
      std::vector<std::pair<int, int>> v_el, int** elem_sto, int* v_inv_nd, int** g_indexL, int* off_nd,
  ...
  int compute_res_qq(
      int Level1, int Level_row, int Level_clmn, int ndof_row_ql, int n_nodes_f, int n_nodes_c, int max_elnd,
      int* off_el, std::vector<std::pair<int, int>> v_el, int** elem_sto, int* v_inv_nd, int** g_indexL,
      int* off_nd, int mem[], double values_q[], int Prol_q[], int len_q[], int len_qoff[]);
  int compute_res_kk(
      int Level1,                             // level
      int Level_row,                          // row level
