...
class PetscPreconditionerM : public PreconditionerM {
 ...
 public:
  ...
  PetscPreconditionerM(const ParallelM::Communicator& comm);
  /// Destructor.
  ...
  static void set_petsc_preconditioner_type(const PreconditionerTypeM& preconditioner_type, PC& pc);
...
// ===============================================
inline PetscPreconditionerM::PetscPreconditionerM(const ParallelM::Communicator& comm)
    : PreconditionerM(comm), _pc(PETSC_NULL) {}
