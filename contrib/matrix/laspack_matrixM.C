...
void LaspackMatrixM::init(
    const unsigned int m, const uint /* n*/, const uint /*m_l*/, const unsigned int /*n_l*/,
    const unsigned int /*nnz*/, const unsigned int) {
  // Ignore calls on initialized objects
  if (this->initialized()) {
    std::cout << " LaspackMatrixM::init: already init";
    return;
  }
