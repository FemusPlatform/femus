...
class LaspackLinearSolverM : public LinearSolverM {
 ...
 public:
  ...
  std::pair<unsigned int, Real> solve(
      SparseMatrixM& matrix, NumericVectorM& solution, NumericVectorM& rhs, const double tol,
      const unsigned int m_its);
  /// Call the Laspack solver
  std::pair<unsigned int, Real> solve(
      SparseMatrixM& matrix, SparseMatrixM& pc, NumericVectorM& solution, NumericVectorM& rhs,
  ...
  void MGSolve(
      ...
      std::vector<NumericVectorM*>& rhs_in, Matrix* P, Matrix* R, const double tol, const unsigned int m_its);
...
inline std::pair<unsigned int, Real> LaspackLinearSolverM::solve(
    SparseMatrixM&, SparseMatrixM&, NumericVectorM&, NumericVectorM&, const double, const unsigned int) {
  std::cerr << "ERROR: LASPACK does not support a user-supplied preconditioner!" << std::endl;
  abort();
