...
class DenseVectorM : public DenseVectorBaseM {
 ...
 public:
  ...
  explicit DenseVectorM(const unsigned int n = 0);
  /// Copy-constructor.
...
// ======================================================
inline DenseVectorM::DenseVectorM(const DenseVectorM& other_vector) : DenseVectorBaseM() {
...
// =================================
inline DenseVectorM::DenseVectorM(const std::vector<double>& other_vector) : _val(other_vector) {}
...
// =================================================
inline void DenseVectorM::resize(const unsigned int n) {
  _val.resize(n);
  zero();
}
// ==================
...
// =================================
inline double DenseVectorM::operator()(const unsigned int i) const {
  assert(i < _val.size());
  return _val[i];
}
// ====================================
inline double& DenseVectorM::operator()(const unsigned int i) {
  assert(i < _val.size());
  return _val[i];
}
// ====================================
inline void DenseVectorM::scale(const double factor) {
  for (unsigned int i = 0; i < _val.size(); i++) _val[i] *= factor;
}
// =======================================
inline DenseVectorM& DenseVectorM::operator*=(const double factor) {
  this->scale(factor);
  return *this;
}
// ======================================
...
// ==================================================================
inline void DenseVectorM::get_principal_subvector(unsigned int sub_n, DenseVectorM& dest) const {
