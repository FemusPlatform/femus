...
// ==========================================
inline VectorND::VectorND(const double x, const double y, const double z) {
  _coords[0] = x;
#if DIMENSION > 1
  _coords[1] = y;
#else
...
// ===========================================================
inline double& VectorND::operator()(const unsigned int i) {
  assert(i < DIMENSION);
  return _coords[i];
}
...
// ========================================================
inline void VectorND::add_scaled(const VectorND& p, const double factor) {
#if DIMENSION == 1
...
#endif
#if DIMENSION == 2
  return VectorND(-_coords[0], -_coords[1]);
#endif
#if DIMENSION == 3
  return VectorND(-_coords[0], -_coords[1], -_coords[2]);
#endif
}
// ==================================================
...
// ===============================================
inline double VectorND::size() const { return std::sqrt(this->size_sq()); }
// ===============================================
...
#endif
#if DIMENSION == 3
  return (_coords[0] == rhs._coords[0] && _coords[1] == rhs._coords[1] && _coords[2] == rhs._coords[2]);
#endif
}
// ========================================================
inline bool VectorND::operator!=(const VectorND& rhs) const { return (!(*this == rhs)); }
...
// Inline functions
// ======================================================
inline Point::Point(const double x, const double y, const double z) : VectorND(x, y, z) {}
// ====================================================
