...
class ParallelObjectM {
 ...
 public:
  ...
  ParallelObjectM(const ParallelM::Communicator& comm_in) : _communicator(comm_in) {}

  // ====================================================================================
  // Copy Constructor.
  ParallelObjectM(const ParallelObjectM& other) : _communicator(other._communicator) {}

  // ====================================================================================
  // "Assignment" operator.  Simply asserts our references
  // are identical because this is the only thing that makes sense
  ParallelObjectM& operator=(const ParallelObjectM& other) {
