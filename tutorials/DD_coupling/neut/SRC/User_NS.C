...
// INITIAL CONDITION ---------------------------------------------------------------------
void MGSolNS::ic_read(int bc_gam, int bc_mat, double xp[], int iel, double u_value[]) {
  double vel[3];
...
// BOUNDARY CONDITIONS -------------------------------------------------------------------
void MGSolNS::bc_read(int bc_gam, int bc_mat, double xp[], int bc_Neum[], int bc_flag[]) {
  bc_Neum[0] = outflow;
