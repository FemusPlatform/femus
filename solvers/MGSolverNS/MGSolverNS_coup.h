#ifndef __mgsolverns_coup_h__
#define __mgsolverns_coup_h__
...
class MGSolNS_coup : public MGSolNS {
 ...
 public:
  ...
  inline int GetIndxEquation(int nPhi, int rowShift, int el_ndof[]) { return nPhi + rowShift * el_ndof[2]; };

  void ContinuityEquation(double JxW_g2, int el_ndof[]);
