#ifndef __userTURB_h__
#define __userTURB_h__
...
/*!  \defgroup TURB_param   Class Table:  energy equation parameters (TURB_param) */
/// \ingroup TURB_param
// ============================================================================
class TURB_param
{
...
public:
  ...
  inline void set_PRT (double val)
  {
    PR_T = val;
  }
  inline void set_HEXT (double val)
  {
    H_EXT = val;
  }
  inline void set_TEXT (double val)
  {
    T_EXT = val;
  }
  inline void set_UNSTEADY (double val)
  {
    UNSTEADY = val;
  }
};
