...
struct Therm4P:Dyn4P
{
  ...
  double _KappaHAndOmegaH[2];
    ...
    Therm4P ():__CP1 (1.025), __CP2 (0.9), __CD1 (1.1), __CD2 (1.9),
    __Prdl_inf (1.3), _LowerKappah (1.e-7), _LowerOmegah (1.e-7)
  {
  };
  ...
  void inline SetIPr (double IPr)
  {
    _IPr = IPr;
  };


  virtual void CalcThermSourceTerms (double *KappaAndOmega, /**< Input variables must be real \f$k\f$ and \f$\omega\f$ */
				     ...
				     double VelGradMod,
				     double muT,
				     double alphaT, double ydist = 1.e-5)
  {
  };

  void ThermTurNearKappaHAndOmegaHValues (double *ThermTurInitKappaAndOmegaValues, double WallDist, double Utau);
  void ThermTurInitKappaAndOmegaValues (double *ThermTurInitKappaAndOmegaValues,
					double vel, double diameter,
					double RefDeltaT);
};
...
struct Therm4P_logKHWH:Therm4P
{
  ...
  void CalcThermSourceTerms (double *KappaAndOmega, /**< Input variables must be real \f$k\f$ and \f$\omega\f$ */
			     double *ThermTurbVariables,	  /**< Input variables for thermal turbulence */
			     double *SourceTerms,
			     double *DissTerms,
			     double *MeccTerms,
