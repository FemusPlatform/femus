#ifndef __mgsolver_nagano_logT__
#define __mgsolver_nagano_logT__
...
class MGSolNaganoLogT : public MGSolRANS_thermal {
 public:
  MGSolNaganoLogT(                             ///< Constructor
  ...
  void inline CalcSourceAndDiss() {
    ...
    _explicit_diss[1] = fabs(_diss[1] + _mecc_term[0]);
    _implicit_diss[1] = 0;
  };
};
