...
enum BoundaryType { WALL = 0, OTHER = 1 };
...
class MGSolRANS : public MGSolDA {
 ...
 protected:
  ...
  double _explicit_diss[2], _explicit_source[2], _implicit_diss[2], _implicit_source[2];
  double _Cross[2], _Log_Cross[2];
  double _Adv, _Lap, _Vel_g[DIMENSION], _MuTurbDxg[DIMENSION], _LapSupg, _LapMuTurb;
  ...
  double _T_nl_dxg[2][DIMENSION], _T_dxg[2][DIMENSION], _T_2dxg[2][DIMENSION * DIMENSION];
 ...
 public:
  ...
  void vol_stab(const int el_ndof2, const int el_ngauss, const int mode, int el_conn[]);
  ...
  void vol_integral(
      ...
      double xx_qnds[] /**< el coords  */, int iel, int el_conn[]);
  ...
  void CalcSCPG(
      double ParVel[], double& tauc, double DefSource, double vel_g[], double mod2_vel, double h_eff);
