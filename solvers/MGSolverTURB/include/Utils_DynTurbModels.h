...
struct DYNturModels {
  ...
  /// Function used to convert real \f$k\f$ and \f$\omega\f$ values to specific turbulence model variable
  /// values
  /**
  ...
  /// Function used to compute real \f$k\f$ and \f$\omega\f$ values from specific turbulence model variable
  /// values
  /**
   *  Computed values are stored inside #DYNturModels::_KappaAndOmega array
   */
  virtual void CalcKappaAndOmega(double* TurbVariables /**< Model dynamical turbulence variables */
  ){};
