...
void Dyn4P_logKW::CalcDynSourceTerms ( double * TurbVariables, double * SourceTerms, double * DissTerms, double MuT,double VelGradMod, double ydist )
{
    CalcKappaAndOmega ( TurbVariables );
    CalcDynCoefficients ( ydist );
    ...
    const double f_exp  = ( 1.-exp ( -1.*_Rd/ ( 3.1 ) ) ) * ( 1.-exp ( -1.*_Rd/ ( 3.1 ) ) ) * ( 1.- 0.3*exp ( -1.*_Rt*_Rt/42.25 ) );
...
void Dyn4P_KW::CalcDynSourceTerms ( double * TurbVariables, double * SourceTerms, double * DissTerms, double MuT,double VelGradMod, double ydist )
{
    CalcKappaAndOmega ( TurbVariables );
    CalcDynCoefficients ( ydist );
...
void Dyn4P_KE::CalcDynSourceTerms ( double * TurbVariables, double * SourceTerms, double * DissTerms, double MuT,double VelGradMod, double ydist )
{
    CalcKappaAndOmega ( TurbVariables );
    CalcDynCoefficients ( ydist );
