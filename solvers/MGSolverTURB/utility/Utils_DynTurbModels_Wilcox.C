...
void DynWilcox_KW::CalcDynSourceTerms ( double * TurbVariables, double * SourceTerms, double * DissTerms, double MuT, double VelGradMod, double ydist )
{
    CalcKappaAndOmega ( TurbVariables );
...
void DynWilcox_logKW::CalcDynSourceTerms ( double * TurbVariables, double * SourceTerms, double * DissTerms, double MuT, double VelGradMod, double ydist )
{
    CalcKappaAndOmega ( TurbVariables );
    double prod_k = 0.5 * _nu * MuT * VelGradMod ;
    if ( _Park==1 ) {
