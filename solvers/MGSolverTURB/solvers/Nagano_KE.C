...
void MGSolNaganoKE::CalcAdvectiveAndDiffusiveTerms ( int i, int j, int el_ndof2, double f_upwind )
{
...
void MGSolNaganoKE::CalcSourceAndDiss ( int el_ndof2 )
{
...
void MGSolNaganoKE::VelocityForSUPG (
    double & mod2_vel,
    double vel_g[],
    double VEL[]
