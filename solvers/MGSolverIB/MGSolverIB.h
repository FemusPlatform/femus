#ifndef __mgsolverIB_h__
#define __mgsolverIB_h__
...
class MGSolIB : public MGSolDA {
  // ======================================================================================================
  // ============= MGSolCOL class data ======================================================================
  // ======================================================================================================
 public:
  IB_param _C_parameter;
 ...
 private:
  ...
  std::vector<double> _InterfaceCoords;
 ...
 public:
  ...
  void bc_set(
      ...
      int elb_ngauss /**< #pt gauss  */, int sign_normal /**< old velocity field  */
  );
  // ==========================================================================
  ...
  void vol_integral(
      ...
      const int mode /**<  rhs int flag */, int el_conn[], double u_old[], int iel);
};
