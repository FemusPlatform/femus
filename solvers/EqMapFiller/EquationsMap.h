...
// ========================================================== 
// This is a constructor  of  EquationsMap (with  std::vector<std::string> & pbname_in).
// For example:  std::vector<std::string>  p={"MG_NavierStokes","MG_Temperature"};  
//               EquationsMap eqmapclass(p);     
EquationsMap(
    std::vector<std::string> & pbname_in
){ 
    Fill_FIELD_map(); 
    Fill_pbName(pbname_in);
  }
...
// ============================================================================= 
/// This function is the constructor of   EquationsMap.  
void Fill_FIELD_map(
   ...
   return; 
    ...
    // ============================================================================= 
    /// This function fills the _pbName vector with equations (listed in _pbName)  
    void Fill_pbName(std::vector<std::string> pbname);  
     // ============================================================================= 
    /// This function fills the FEMUS problem with equations (listed in _pbName)  
    void FillEquationMap(
          FEMUS& FemusProblem                ///< FemusProblem
//           const std::vector<FIELDS>& pbName   ///< list of equation (from Simulation_Configuration.in) 
    );
      // ============================================================================= 
